...
export default function SignUpScreen({ navigation }) {
  ...
  const EMAIL_REGEX = // regex pour filtrer les email : le user ne peut entrer que un format email
  ...
  const handleRegister = () => { //fonction handleRegister est appelée au touch sur le bouton submit
